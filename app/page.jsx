    ...
    <>
        <div className="container mx-auto mb-10">
          <div className="grid md:grid-cols-3 grid-cols-1 md:mt-32 rounded-xl shadow-xl">
            ...
            <div className="flex h-full items-center dark:bg-gray-500 justify-center border md:rounded-r-xl">
                <div className="w-full p-10">
                    <div className="mb-5">
                        <label htmlFor="email" className="block text-center mb-2 text-2xl font-medium text-gray-900 dark:text-white">Log In</label>
                    </div>  
                    <div className="mb-5">
                        <label htmlFor="Email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
                        <input type="email" onChange={(e) => setEmail(e.target.value)} className={`${errors.email ? 'outline-red-600 ring-red-600 dark:outline-yellow-500 dark:ring-yellow-500' : 'border border-gray-300' } shadow-sm bg-gray-50  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light`} placeholder="name@mediatamaweb.com" />
                    </div>  
                    <div className="mb-5">
                    ...
                    <div className="flex justify-between mb-5">
                      ...
                      <div className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Forgot Password?</div>
                    </div>
