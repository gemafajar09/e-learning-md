...
export default function Login() {
    return(
        <>
            <div className="container mx-auto mt-auto mb-10">
                <div className="flex justify-center  mt-10">
                    <img src="https://mediatamaweb.co.id/_next/image?url=%2Fassets%2Flogo.png&w=384&q=75" className="w-auto" alt="logo" />
                </div>
                <div className="flex h-full items-cente justify-center">
                    <div className="border w-[400px] rounded-md p-5">
                        <div className="mb-5">
